-- rebuild.sql - full DB rebuild script for Task Two
-- Drops any existing objects, creates type and tables, inserts sample data,
-- and runs the two Task One queries (description update and image path update) as the last steps.
...
-- Optional sample account data
INSERT INTO public.account (account_firstname, account_lastname, account_email, account_password, account_type)
VALUES ('Bruce','Wayne','bruce@wayneenterprises.com','Batman123','Client');

-- 5) Last: the two Task One queries that must run as the final steps
-- Description update for GM Hummer
