...
-- 4) Create FK relationship: inventory.classification_id → classification.classification_id
...
-- 6) Insert classification seed data
...
-- 8) Task One: Update GM Hummer description (replace "small interiors" → "a huge interior")
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM'
  AND inv_model = 'Hummer';

-- 9) Task One: Update all inventory paths to '/images/vehicles/...'
UPDATE public.inventory
SET
